...
def start_parser():
    for object in CLite.objects.all():
        object.delete()
    parser('https://www.bestchange.ru/litecoin-to-alfaclick.html', CLite)
    for object in CEther.objects.all():
        object.delete()
    parser('https://www.bestchange.ru/ethereum-to-alfaclick.html', CEther)
    for object in CBit.objects.all():
        object.delete()
    parser('https://www.bestchange.ru/bitcoin-to-alfaclick.html', CBit)
    for object in CLite.objects.all():
        object.get = object.get.split('.')[0]
        object.save()
    for object in CEther.objects.all():
        object.get = object.get.split('.')[0]
        object.save()
